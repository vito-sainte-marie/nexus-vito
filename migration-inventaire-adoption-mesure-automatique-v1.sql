...
-- restent la seule source du temps NEXUS automatique -- pas de colonne
-- dupliquée pour la durée, qui reste calculée (Article 11).
--
-- Appliquée le 18/08/2026 sur le projet Supabase uzhjpqpctpvxytxpxoqz via
-- apply_migration (nom : inventaire_adoption_mesure_automatique). Ce fichier
-- est une copie de traçabilité locale (pas de dossier supabase/migrations
-- synchronisé automatiquement dans ce projet).
