...
// moteur NEXUS).
//
// Inclure dans une page : <script src="nexus-raccourcis-catalogue.js?v=20260904-0104"></script>
// ------------------------------------------------------------
...
(function (global) {
  const RACCOURCIS_CATALOGUE = {
    ...
    'NEXUS-Carburants-Pilotage-v1.html': { label: 'Carburants Performance', emoji: '📈', desc: 'Volumes, mix et moteurs de performance' },
    'NEXUS-FDJ-Analyse-v1.html': { label: 'FDJ Performance', emoji: '📊', desc: 'Tendances, jeux, équipe, stock et écarts', forfait: 'professional' },
