...
| | |
|---|---|
| Date UTC | `2026-09-17T18:13:06Z` |
| Commit testé | `69b82b921589e18e9b261859bd146d225cb0eb3c` |
...
| `supabase/phase-c/20260916230000_mutations_de_validation.sql` | `7c55c75107bd35fab6cc7e84646246938045c54c0ba2bf6cbaf604e7141d835e` | `dc42b24f47adce1ef074a3ae21a7fcc988088b20` |
...
INSERT 0 1
UPDATE 1
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:176: NOTICE:  M1 PASSE — refus RLS : new row violates row-level security policy for table "fdj_cash_controls"
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:200: NOTICE:  M2 PASSE — 0 ligne modifiée (la caisse est invisible en écriture à l'employé).
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:212: NOTICE:  M2 bis PASSE — la caisse est intacte : 455 / provisoire.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:232: NOTICE:  M3 PASSE — un employé ne peut pas valider la caisse d'un collègue.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:265: NOTICE:  M4 PASSE — lecture directe fermée : 0 pour sa caisse, 0 pour celle du collègue.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:297: NOTICE:  M4 bis PASSE — 1 quart rendu, écarts -2.50 puis -1.00, aucun champ manager.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:323: NOTICE:  M5 PASSE — refus du trigger : Quart FDJ : changer de titulaire est un transfert de responsabilité, pas une modification de champ.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:345: NOTICE:  M6 PASSE — refus (42501) : Quart FDJ : cette modification passe par une commande NEXUS (ouverture, transfert, validation), pas par une écriture directe.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:369: NOTICE:  M7 PASSE — validation d'ouverture et chaînage de quart toujours possibles.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:391: NOTICE:  M8 PASSE — refus (42501) : Journal FDJ : une action ne peut être imputée qu'à soi-même (acteur_id attendu : aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa).
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:409: NOTICE:  M8 bis PASSE — journalisation en son nom et journalisation automatique intactes.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:475: NOTICE:  M9 PASSE — le manager contrôle, valide, saisit une feuille et dépose un rapport.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:496: NOTICE:  M10 PASSE — refus (42501) : new row violates row-level security policy for table "fdj_corrections"
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:527: NOTICE:  M11 PASSE — refus RLS : new row violates row-level security policy for table "fdj_stock_movements"
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:590: NOTICE:  M11 bis PASSE — employee_id vient du quart, created_by de auth.uid(), y compris en saisie manager.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:680: NOTICE:  M12 PASSE — refus du trigger : Quart FDJ : changer de titulaire est un transfert de responsabilité, pas une modification de champ.
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:680: NOTICE:  M12 PASSE — transfert sans motif refusé : Un transfert de responsabilité exige un motif explicite
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:680: NOTICE:  M12 PASSE — écriture directe refusée, transfert motivé accepté et journalisé.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:711: NOTICE:  M13 PASSE — update direct du manager sans effet : 0 ligne, aucune erreur.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:894: NOTICE:  DÉMONTAGE — 22 ligne(s) dépendante(s) retirée(s) en 3 passe(s), dont 3 du journal de caisse ; 0 fixture restante, journal re-scellé.
DO
psql:supabase/phase-c/20260916230000_mutations_de_validation.sql:896: NOTICE:  ===== LES TREIZE MUTATIONS ONT LE COMPORTEMENT ATTENDU =====
DO
ROLLBACK
```
