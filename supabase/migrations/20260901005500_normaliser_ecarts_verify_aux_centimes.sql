-- NEXUS Verify — normalisation monétaire des écarts aux centimes
-- 01/09/2026
--
-- Les calculs JavaScript peuvent produire des résidus binaires comme
-- 9.094947017729282e-13 pour un écart métier de 0,00 €. Les colonnes
-- d'écart sont des montants monétaires : la vérité stockée doit donc être
-- au centime avant toute qualification, validation ou analyse.
...
-- Nettoyage additif des résidus déjà présents. Aucun constat n'est supprimé :
-- seules les décimales inférieures au centime sont normalisées.
