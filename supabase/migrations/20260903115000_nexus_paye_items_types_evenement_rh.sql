-- Les événements RH groupés (03/09/2026) émettent deux nouveaux type_item que
-- la contrainte d'origine ne connaissait pas : toute décision manager sur une
-- carte d'absence échouait silencieusement à l'écriture.
