...
`decision-1.md` puis `decision-2.md` de ce lot autorisent la lecture
Production pour les mesures d'impact, mais la Bible NEXUS et `CLAUDE.md`
distinguent strictement l'accès
