...
// Configuration d'environnement (portée du rail, 04/09/2026). L'URL et la
// clé ne sont plus écrites ici : elles viennent de `nexus-config.js`, généré
// au build depuis les variables d'environnement. Un même code source sert
// donc la recette et la production, et c'est le build — jamais le dépôt —
// qui décide de la base visée. C'est l'élément de la chaîne build/config
// que le portage du 22/09 devait apporter ; le reste de ce fichier reste la
// lignée candidate (voir NEXUS-ACCES-REGLE et NEXUS-FUSEAU-METIER ci-dessous).
//
