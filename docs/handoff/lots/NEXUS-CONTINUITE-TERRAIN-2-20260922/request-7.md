...
preuves:
  ...
  - id: cause-isolee-290a217f
    classe: VERIFIED
    valeur: diff-664af985-290a217f-limite-a-tests-yml
  - id: nexus-auth-shrink
    classe: VERIFIED
    valeur: 932-lignes-avant-305-apres-fonctions-nommees-disparues
  ...
  - id: absence-sur-rail
    classe: VERIFIED
    valeur: grep-nexusEstManager-nexusFuseauValide-zero-hit-sur-handoff-continuite-20260920
