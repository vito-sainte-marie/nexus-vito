...
(function () {
  ...
  document.write('<script src="nexus-carburant-commande-donnees-core.js?v=20260903-1303"><\/script>');
  ...
  if (estPilotageCarburants()) {
    document.write('<script src="nexus-carburant-commande-coherence-v1.js?v=20260903-1303"><\/script>');
  }
  ...
  function chargerCorrectifUI() {
    ...
    s.src = 'nexus-carburants-ui-correctifs-20260901.js?v=20260903-1303';
