...
function ecransDuDepot(racine) {
  // Même repli que `analyserDepot` : sans ce `|| RACINE`, la fonction exportée
  // plante sur un appel sans argument alors que sa voisine, elle, accepte.
  return fs.readdirSync(racine || RACINE)
