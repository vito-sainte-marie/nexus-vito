...
# invoqué quand une URL est fournie — elle porte alors son propre moyen
# d'authentification, ou `PGPASSWORD` est déjà dans l'environnement, et il n'y
# a plus de raison d'appeler un binaire absent sur un runner Linux.
#
