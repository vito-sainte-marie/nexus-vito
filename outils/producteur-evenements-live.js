...
function evenementsAgentGithub(horodatage, { lister } = {}) {
  ...
  for (const r of runs) {
    ...
    evts.push(evenement({
      ...
      acteur: 'claude-code-action', role: 'execution',
...
module.exports = { produire, filtrer, sqlIngestion, sqlIngestionUnitaire, litteral, evenement, identifiant, evenementsRegistre, evenementsGardes, evenementBarriere, evenementBranchesEnRade, evenementDeploiement, evenementsAgentGithub, extraireNumeroIssue, GARDES };
